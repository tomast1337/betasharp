...
{
    public EmptyChunk(World world, int x, int z) : base(world, x, z) => Empty = true;

    public EmptyChunk(World world, byte[] blocks, int x, int z) : base(world, blocks, x, z) => Empty = true;
