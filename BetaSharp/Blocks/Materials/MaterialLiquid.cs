...
{
    /// <summary>
    /// A liquid material, such as water or lava. Liquids are not solid and do not block movement, but they can still have a map color and be replaced by other blocks.
    /// </summary>
