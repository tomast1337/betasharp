...
public enum GLEnum : int
{
    ...
    [NativeName("Name", "GL_FALSE")] False = 0x0,
    [NativeName("Name", "GL_TRUE")] True = 0x1,
    [NativeName("Name", "GL_POINTS")] Points = 0x0,
    [NativeName("Name", "GL_LINES")] Lines = 0x1,
    [NativeName("Name", "GL_LINE_LOOP")] LineLoop = 0x2,
    [NativeName("Name", "GL_LINE_STRIP")] LineStrip = 0x3,
    [NativeName("Name", "GL_TRIANGLES")] Triangles = 0x4,
    ...
    TriangleFan = 0x6,
    [NativeName("Name", "GL_QUADS")] Quads = 0x7,
    [NativeName("Name", "GL_NEVER")] Never = 0x200,
    [NativeName("Name", "GL_LESS")] Less = 0x201,
    [NativeName("Name", "GL_EQUAL")] Equal = 0x202,
    [NativeName("Name", "GL_LEQUAL")] Lequal = 0x203,
    [NativeName("Name", "GL_GREATER")] Greater = 0x204,
    [NativeName("Name", "GL_NOTEQUAL")] Notequal = 0x205,
    [NativeName("Name", "GL_GEQUAL")] Gequal = 0x206,
    [NativeName("Name", "GL_ALWAYS")] Always = 0x207,
    [NativeName("Name", "GL_ZERO")] Zero = 0x0,
    [NativeName("Name", "GL_ONE")] One = 0x1,
    [NativeName("Name", "GL_SRC_COLOR")] SrcColor = 0x300,

    [NativeName("Name", "GL_ONE_MINUS_SRC_COLOR")]
    OneMinusSrcColor = 0x301,
    [NativeName("Name", "GL_SRC_ALPHA")] SrcAlpha = 0x302,

    [NativeName("Name", "GL_ONE_MINUS_SRC_ALPHA")]
    OneMinusSrcAlpha = 0x303,
    [NativeName("Name", "GL_DST_ALPHA")] DstAlpha = 0x304,

    [NativeName("Name", "GL_ONE_MINUS_DST_ALPHA")]
    OneMinusDstAlpha = 0x305,
    [NativeName("Name", "GL_DST_COLOR")] DstColor = 0x306,
    ...
    [NativeName("Name", "GL_NONE")] None = 0x0,
    [NativeName("Name", "GL_FRONT_LEFT")] FrontLeft = 0x400,
    [NativeName("Name", "GL_FRONT_RIGHT")] FrontRight = 0x401,
    [NativeName("Name", "GL_BACK_LEFT")] BackLeft = 0x402,
    [NativeName("Name", "GL_BACK_RIGHT")] BackRight = 0x403,
    [NativeName("Name", "GL_FRONT")] Front = 0x404,
    [NativeName("Name", "GL_BACK")] Back = 0x405,
    [NativeName("Name", "GL_LEFT")] Left = 0x406,
    [NativeName("Name", "GL_RIGHT")] Right = 0x407,

    [NativeName("Name", "GL_FRONT_AND_BACK")]
    FrontAndBack = 0x408,
    [NativeName("Name", "GL_NO_ERROR")] NoError = 0x0,
    ...
    OutOfMemory = 0x505,
    [NativeName("Name", "GL_CW")] CW = 0x900,
    [NativeName("Name", "GL_CCW")] Ccw = 0x901,
    [NativeName("Name", "GL_POINT_SIZE")] PointSize = 0xB11,
    ...
    [NativeName("Name", "GL_LINE_SMOOTH")] LineSmooth = 0xB20,
    [NativeName("Name", "GL_LINE_WIDTH")] LineWidth = 0xB21,
    ...
    PolygonSmooth = 0xB41,
    [NativeName("Name", "GL_CULL_FACE")] CullFace = 0xB44,

    [NativeName("Name", "GL_CULL_FACE_MODE")]
    CullFaceMode = 0xB45,
    [NativeName("Name", "GL_FRONT_FACE")] FrontFace = 0xB46,
    [NativeName("Name", "GL_DEPTH_RANGE")] DepthRange = 0xB70,
    [NativeName("Name", "GL_DEPTH_TEST")] DepthTest = 0xB71,
    ...
    [NativeName("Name", "GL_DEPTH_FUNC")] DepthFunc = 0xB74,
    ...
    [NativeName("Name", "GL_STENCIL_REF")] StencilRef = 0xB97,

    [NativeName("Name", "GL_STENCIL_WRITEMASK")]
    StencilWritemask = 0xB98,
    [NativeName("Name", "GL_VIEWPORT")] Viewport = 0xBA2,
    [NativeName("Name", "GL_DITHER")] Dither = 0xBD0,
    [NativeName("Name", "GL_BLEND_DST")] BlendDst = 0xBE0,
    [NativeName("Name", "GL_BLEND_SRC")] BlendSrc = 0xBE1,
    [NativeName("Name", "GL_BLEND")] Blend = 0xBE2,

    [NativeName("Name", "GL_LOGIC_OP_MODE")]
    LogicOpMode = 0xBF0,
    [NativeName("Name", "GL_DRAW_BUFFER")] DrawBuffer = 0xC01,
    [NativeName("Name", "GL_READ_BUFFER")] ReadBuffer = 0xC02,
    [NativeName("Name", "GL_SCISSOR_BOX")] ScissorBox = 0xC10,
    ...
    Doublebuffer = 0xC32,
    [NativeName("Name", "GL_STEREO")] Stereo = 0xC33,
    ...
    SubpixelBits = 0xD50,
    [NativeName("Name", "GL_TEXTURE_1D")] Texture1D = 0xDE0,
    [NativeName("Name", "GL_TEXTURE_2D")] Texture2D = 0xDE1,
    ...
    [NativeName("Name", "GL_DONT_CARE")] DontCare = 0x1100,
    [NativeName("Name", "GL_FASTEST")] Fastest = 0x1101,
    [NativeName("Name", "GL_NICEST")] Nicest = 0x1102,
    [NativeName("Name", "GL_BYTE")] Byte = 0x1400,

    [NativeName("Name", "GL_UNSIGNED_BYTE")]
    UnsignedByte = 0x1401,
    [NativeName("Name", "GL_SHORT")] Short = 0x1402,

    [NativeName("Name", "GL_UNSIGNED_SHORT")]
    UnsignedShort = 0x1403,
    [NativeName("Name", "GL_INT")] Int = 0x1404,

    [NativeName("Name", "GL_UNSIGNED_INT")]
    UnsignedInt = 0x1405,
    [NativeName("Name", "GL_FLOAT")] Float = 0x1406,
    ...
    [NativeName("Name", "GL_CLEAR")] Clear = 0x1500,
    [NativeName("Name", "GL_AND")] And = 0x1501,
    [NativeName("Name", "GL_AND_REVERSE")] AndReverse = 0x1502,
    [NativeName("Name", "GL_COPY")] Copy = 0x1503,

    [NativeName("Name", "GL_AND_INVERTED")]
    AndInverted = 0x1504,
    [NativeName("Name", "GL_NOOP")] Noop = 0x1505,
    [NativeName("Name", "GL_XOR")] Xor = 0x1506,
    [NativeName("Name", "GL_OR")] Or = 0x1507,
    [NativeName("Name", "GL_NOR")] Nor = 0x1508,
    [NativeName("Name", "GL_EQUIV")] Equiv = 0x1509,
    [NativeName("Name", "GL_INVERT")] Invert = 0x150A,
    [NativeName("Name", "GL_OR_REVERSE")] OrReverse = 0x150B,

    [NativeName("Name", "GL_COPY_INVERTED")]
    CopyInverted = 0x150C,
    [NativeName("Name", "GL_OR_INVERTED")] OrInverted = 0x150D,
    [NativeName("Name", "GL_NAND")] Nand = 0x150E,
    [NativeName("Name", "GL_SET")] Set = 0x150F,
    [NativeName("Name", "GL_TEXTURE")] Texture = 0x1702,
    [NativeName("Name", "GL_COLOR")] Color = 0x1800,
    [NativeName("Name", "GL_DEPTH")] Depth = 0x1801,
    [NativeName("Name", "GL_STENCIL")] Stencil = 0x1802,
    ...
    [NativeName("Name", "GL_RED")] Red = 0x1903,
    [NativeName("Name", "GL_GREEN")] Green = 0x1904,
    [NativeName("Name", "GL_BLUE")] Blue = 0x1905,
    [NativeName("Name", "GL_ALPHA")] Alpha = 0x1906,
    [NativeName("Name", "GL_RGB")] Rgb = 0x1907,
    [NativeName("Name", "GL_RGBA")] Rgba = 0x1908,
    [NativeName("Name", "GL_POINT")] Point = 0x1B00,
    [NativeName("Name", "GL_LINE")] Line = 0x1B01,
    [NativeName("Name", "GL_FILL")] Fill = 0x1B02,
    [NativeName("Name", "GL_KEEP")] Keep = 0x1E00,
    [NativeName("Name", "GL_REPLACE")] Replace = 0x1E01,
    [NativeName("Name", "GL_INCR")] Incr = 0x1E02,
    [NativeName("Name", "GL_DECR")] Decr = 0x1E03,
    [NativeName("Name", "GL_VENDOR")] Vendor = 0x1F00,
    [NativeName("Name", "GL_RENDERER")] Renderer = 0x1F01,
    [NativeName("Name", "GL_VERSION")] Version = 0x1F02,
    [NativeName("Name", "GL_EXTENSIONS")] Extensions = 0x1F03,
    [NativeName("Name", "GL_NEAREST")] Nearest = 0x2600,
    [NativeName("Name", "GL_LINEAR")] Linear = 0x2601,
    ...
    TextureWrapT = 0x2803,
    [NativeName("Name", "GL_REPEAT")] Repeat = 0x2901,
    [NativeName("Name", "GL_CURRENT_BIT")] CurrentBit = 0x1,
    [NativeName("Name", "GL_POINT_BIT")] PointBit = 0x2,
    [NativeName("Name", "GL_LINE_BIT")] LineBit = 0x4,
    [NativeName("Name", "GL_POLYGON_BIT")] PolygonBit = 0x8,
    ...
    LightingBit = 0x40,
    [NativeName("Name", "GL_FOG_BIT")] FogBit = 0x80,
    ...
    TransformBit = 0x1000,
    [NativeName("Name", "GL_ENABLE_BIT")] EnableBit = 0x2000,
    [NativeName("Name", "GL_HINT_BIT")] HintBit = 0x8000,
    [NativeName("Name", "GL_EVAL_BIT")] EvalBit = 0x10000,
    [NativeName("Name", "GL_LIST_BIT")] ListBit = 0x20000,
    [NativeName("Name", "GL_TEXTURE_BIT")] TextureBit = 0x40000,
    [NativeName("Name", "GL_SCISSOR_BIT")] ScissorBit = 0x80000,

    [NativeName("Name", "GL_ALL_ATTRIB_BITS")]
    AllAttribBits = unchecked((int)0xFFFFFFFF),
    [NativeName("Name", "GL_QUAD_STRIP")] QuadStrip = 0x8,
    [NativeName("Name", "GL_POLYGON")] Polygon = 0x9,
    [NativeName("Name", "GL_ACCUM")] Accum = 0x100,
    [NativeName("Name", "GL_LOAD")] Load = 0x101,
    [NativeName("Name", "GL_RETURN")] Return = 0x102,
    [NativeName("Name", "GL_MULT")] Mult = 0x103,
    [NativeName("Name", "GL_ADD")] Add = 0x104,
    [NativeName("Name", "GL_AUX0")] Aux0 = 0x409,
    [NativeName("Name", "GL_AUX1")] Aux1 = 0x40A,
    [NativeName("Name", "GL_AUX2")] Aux2 = 0x40B,
    [NativeName("Name", "GL_AUX3")] Aux3 = 0x40C,
    [NativeName("Name", "GL_2D")] Gl2D = 0x600,
    [NativeName("Name", "GL_3D")] Gl3D = 0x601,
    [NativeName("Name", "GL_3D_COLOR")] Gl3DColor = 0x602,
    ...
    [NativeName("Name", "GL_POINT_TOKEN")] PointToken = 0x701,
    [NativeName("Name", "GL_LINE_TOKEN")] LineToken = 0x702,
    ...
    [NativeName("Name", "GL_EXP")] Exp = 0x800,
    [NativeName("Name", "GL_EXP2")] Exp2 = 0x801,
    [NativeName("Name", "GL_COEFF")] Coeff = 0xA00,
    [NativeName("Name", "GL_ORDER")] Order = 0xA01,
    [NativeName("Name", "GL_DOMAIN")] Domain = 0xA02,
    ...
    [NativeName("Name", "GL_LIST_MODE")] ListMode = 0xB30,

    [NativeName("Name", "GL_MAX_LIST_NESTING")]
    MaxListNesting = 0xB31,
    [NativeName("Name", "GL_LIST_BASE")] ListBase = 0xB32,
    [NativeName("Name", "GL_LIST_INDEX")] ListIndex = 0xB33,

    [NativeName("Name", "GL_POLYGON_STIPPLE")]
    PolygonStipple = 0xB42,
    [NativeName("Name", "GL_EDGE_FLAG")] EdgeFlag = 0xB43,
    [NativeName("Name", "GL_LIGHTING")] Lighting = 0xB50,
    ...
    [NativeName("Name", "GL_SHADE_MODEL")] ShadeModel = 0xB54,
    ...
    ColorMaterial = 0xB57,
    [NativeName("Name", "GL_FOG")] Fog = 0xB60,
    [NativeName("Name", "GL_FOG_INDEX")] FogIndex = 0xB61,
    [NativeName("Name", "GL_FOG_DENSITY")] FogDensity = 0xB62,
    [NativeName("Name", "GL_FOG_START")] FogStart = 0xB63,
    [NativeName("Name", "GL_FOG_END")] FogEnd = 0xB64,
    [NativeName("Name", "GL_FOG_MODE")] FogMode = 0xB65,
    [NativeName("Name", "GL_FOG_COLOR")] FogColor = 0xB66,

    [NativeName("Name", "GL_ACCUM_CLEAR_VALUE")]
    AccumClearValue = 0xB80,
    [NativeName("Name", "GL_MATRIX_MODE")] MatrixMode = 0xBA0,
    [NativeName("Name", "GL_NORMALIZE")] Normalize = 0xBA1,
    ...
    [NativeName("Name", "GL_ALPHA_TEST")] AlphaTest = 0xBC0,
    ...
    AlphaTestRef = 0xBC2,
    [NativeName("Name", "GL_LOGIC_OP")] LogicOp = 0xBF1,
    [NativeName("Name", "GL_AUX_BUFFERS")] AuxBuffers = 0xC00,
    ...
    [NativeName("Name", "GL_INDEX_MODE")] IndexMode = 0xC30,
    [NativeName("Name", "GL_RGBA_MODE")] RgbaMode = 0xC31,
    [NativeName("Name", "GL_RENDER_MODE")] RenderMode = 0xC40,
    ...
    [NativeName("Name", "GL_FOG_HINT")] FogHint = 0xC54,
    ...
    [NativeName("Name", "GL_MAP_COLOR")] MapColor = 0xD10,
    [NativeName("Name", "GL_MAP_STENCIL")] MapStencil = 0xD11,
    [NativeName("Name", "GL_INDEX_SHIFT")] IndexShift = 0xD12,

    [NativeName("Name", "GL_INDEX_OFFSET")]
    IndexOffset = 0xD13,
    [NativeName("Name", "GL_RED_SCALE")] RedScale = 0xD14,
    [NativeName("Name", "GL_RED_BIAS")] RedBias = 0xD15,
    [NativeName("Name", "GL_ZOOM_X")] ZoomX = 0xD16,
    [NativeName("Name", "GL_ZOOM_Y")] ZoomY = 0xD17,
    [NativeName("Name", "GL_GREEN_SCALE")] GreenScale = 0xD18,
    [NativeName("Name", "GL_GREEN_BIAS")] GreenBias = 0xD19,
    [NativeName("Name", "GL_BLUE_SCALE")] BlueScale = 0xD1A,
    [NativeName("Name", "GL_BLUE_BIAS")] BlueBias = 0xD1B,
    [NativeName("Name", "GL_ALPHA_SCALE")] AlphaScale = 0xD1C,
    [NativeName("Name", "GL_ALPHA_BIAS")] AlphaBias = 0xD1D,
    [NativeName("Name", "GL_DEPTH_SCALE")] DepthScale = 0xD1E,
    [NativeName("Name", "GL_DEPTH_BIAS")] DepthBias = 0xD1F,

    [NativeName("Name", "GL_MAX_EVAL_ORDER")]
    MaxEvalOrder = 0xD30,
    [NativeName("Name", "GL_MAX_LIGHTS")] MaxLights = 0xD31,
    ...
    [NativeName("Name", "GL_INDEX_BITS")] IndexBits = 0xD51,
    [NativeName("Name", "GL_RED_BITS")] RedBits = 0xD52,
    [NativeName("Name", "GL_GREEN_BITS")] GreenBits = 0xD53,
    [NativeName("Name", "GL_BLUE_BITS")] BlueBits = 0xD54,
    [NativeName("Name", "GL_ALPHA_BITS")] AlphaBits = 0xD55,
    [NativeName("Name", "GL_DEPTH_BITS")] DepthBits = 0xD56,
    ...
    [NativeName("Name", "GL_AUTO_NORMAL")] AutoNormal = 0xD80,

    [NativeName("Name", "GL_MAP1_COLOR_4")]
    Map1Color4 = 0xD90,
    [NativeName("Name", "GL_MAP1_INDEX")] Map1Index = 0xD91,
    [NativeName("Name", "GL_MAP1_NORMAL")] Map1Normal = 0xD92,
    ...
    Map2Color4 = 0xDB0,
    [NativeName("Name", "GL_MAP2_INDEX")] Map2Index = 0xDB1,
    [NativeName("Name", "GL_MAP2_NORMAL")] Map2Normal = 0xDB2,
    ...
    [NativeName("Name", "GL_AMBIENT")] Ambient = 0x1200,
    [NativeName("Name", "GL_DIFFUSE")] Diffuse = 0x1201,
    [NativeName("Name", "GL_SPECULAR")] Specular = 0x1202,
    [NativeName("Name", "GL_POSITION")] Position = 0x1203,
    ...
    SpotExponent = 0x1205,
    [NativeName("Name", "GL_SPOT_CUTOFF")] SpotCutoff = 0x1206,
    ...
    [NativeName("Name", "GL_COMPILE")] Compile = 0x1300,

    [NativeName("Name", "GL_COMPILE_AND_EXECUTE")]
    CompileAndExecute = 0x1301,
    [NativeName("Name", "GL_2_BYTES")] Gl2Bytes = 0x1407,
    [NativeName("Name", "GL_3_BYTES")] Gl3Bytes = 0x1408,
    [NativeName("Name", "GL_4_BYTES")] Gl4Bytes = 0x1409,
    [NativeName("Name", "GL_EMISSION")] Emission = 0x1600,
    [NativeName("Name", "GL_SHININESS")] Shininess = 0x1601,
    ...
    ColorIndexes = 0x1603,
    [NativeName("Name", "GL_MODELVIEW")] Modelview = 0x1700,
    [NativeName("Name", "GL_PROJECTION")] Projection = 0x1701,
    [NativeName("Name", "GL_COLOR_INDEX")] ColorIndex = 0x1900,
    [NativeName("Name", "GL_LUMINANCE")] Luminance = 0x1909,

    [NativeName("Name", "GL_LUMINANCE_ALPHA")]
    LuminanceAlpha = 0x190A,
    [NativeName("Name", "GL_BITMAP")] Bitmap = 0x1A00,
    [NativeName("Name", "GL_RENDER")] Render = 0x1C00,
    [NativeName("Name", "GL_FEEDBACK")] Feedback = 0x1C01,
    [NativeName("Name", "GL_SELECT")] Select = 0x1C02,
    [NativeName("Name", "GL_FLAT")] Flat = 0x1D00,
    [NativeName("Name", "GL_SMOOTH")] Smooth = 0x1D01,
    [NativeName("Name", "GL_S")] S = 0x2000,
    [NativeName("Name", "GL_T")] T = 0x2001,
    [NativeName("Name", "GL_R")] R = 0x2002,
    [NativeName("Name", "GL_Q")] Q = 0x2003,
    [NativeName("Name", "GL_MODULATE")] Modulate = 0x2100,
    [NativeName("Name", "GL_DECAL")] Decal = 0x2101,
    ...
    [NativeName("Name", "GL_TEXTURE_ENV")] TextureEnv = 0x2300,
    [NativeName("Name", "GL_EYE_LINEAR")] EyeLinear = 0x2400,

    [NativeName("Name", "GL_OBJECT_LINEAR")]
    ObjectLinear = 0x2401,
    [NativeName("Name", "GL_SPHERE_MAP")] SphereMap = 0x2402,
    ...
    ObjectPlane = 0x2501,
    [NativeName("Name", "GL_EYE_PLANE")] EyePlane = 0x2502,
    [NativeName("Name", "GL_CLAMP")] Clamp = 0x2900,
    [NativeName("Name", "GL_CLIP_PLANE0")] ClipPlane0 = 0x3000,
    [NativeName("Name", "GL_CLIP_PLANE1")] ClipPlane1 = 0x3001,
    [NativeName("Name", "GL_CLIP_PLANE2")] ClipPlane2 = 0x3002,
    [NativeName("Name", "GL_CLIP_PLANE3")] ClipPlane3 = 0x3003,
    [NativeName("Name", "GL_CLIP_PLANE4")] ClipPlane4 = 0x3004,
    [NativeName("Name", "GL_CLIP_PLANE5")] ClipPlane5 = 0x3005,
    [NativeName("Name", "GL_LIGHT0")] Light0 = 0x4000,
    [NativeName("Name", "GL_LIGHT1")] Light1 = 0x4001,
    [NativeName("Name", "GL_LIGHT2")] Light2 = 0x4002,
    [NativeName("Name", "GL_LIGHT3")] Light3 = 0x4003,
    [NativeName("Name", "GL_LIGHT4")] Light4 = 0x4004,
    [NativeName("Name", "GL_LIGHT5")] Light5 = 0x4005,
    [NativeName("Name", "GL_LIGHT6")] Light6 = 0x4006,
    [NativeName("Name", "GL_LIGHT7")] Light7 = 0x4007,
    ...
    [NativeName("Name", "GL_DOUBLE")] Double = 0x140A,
    ...
    [NativeName("Name", "GL_R3_G3_B2")] R3G3B2 = 0x2A10,
    [NativeName("Name", "GL_RGB4")] Rgb4 = 0x804F,
    [NativeName("Name", "GL_RGB5")] Rgb5 = 0x8050,
    [NativeName("Name", "GL_RGB8")] Rgb8 = 0x8051,
    [NativeName("Name", "GL_RGB10")] Rgb10 = 0x8052,
    [NativeName("Name", "GL_RGB12")] Rgb12 = 0x8053,
    [NativeName("Name", "GL_RGB16")] Rgb16 = 0x8054,
    [NativeName("Name", "GL_RGBA2")] Rgba2 = 0x8055,
    [NativeName("Name", "GL_RGBA4")] Rgba4 = 0x8056,
    [NativeName("Name", "GL_RGB5_A1")] Rgb5A1 = 0x8057,
    [NativeName("Name", "GL_RGBA8")] Rgba8 = 0x8058,
    [NativeName("Name", "GL_RGB10_A2")] Rgb10A2 = 0x8059,
    [NativeName("Name", "GL_RGBA12")] Rgba12 = 0x805A,
    [NativeName("Name", "GL_RGBA16")] Rgba16 = 0x805B,
    ...
    NormalArray = 0x8075,
    [NativeName("Name", "GL_COLOR_ARRAY")] ColorArray = 0x8076,
    [NativeName("Name", "GL_INDEX_ARRAY")] IndexArray = 0x8077,
    ...
    [NativeName("Name", "GL_ALPHA4")] Alpha4 = 0x803B,
    [NativeName("Name", "GL_ALPHA8")] Alpha8 = 0x803C,
    [NativeName("Name", "GL_ALPHA12")] Alpha12 = 0x803D,
    [NativeName("Name", "GL_ALPHA16")] Alpha16 = 0x803E,
    [NativeName("Name", "GL_LUMINANCE4")] Luminance4 = 0x803F,
    [NativeName("Name", "GL_LUMINANCE8")] Luminance8 = 0x8040,
    [NativeName("Name", "GL_LUMINANCE12")] Luminance12 = 0x8041,
    [NativeName("Name", "GL_LUMINANCE16")] Luminance16 = 0x8042,
    ...
    [NativeName("Name", "GL_INTENSITY")] Intensity = 0x8049,
    [NativeName("Name", "GL_INTENSITY4")] Intensity4 = 0x804A,
    [NativeName("Name", "GL_INTENSITY8")] Intensity8 = 0x804B,
    [NativeName("Name", "GL_INTENSITY12")] Intensity12 = 0x804C,
    [NativeName("Name", "GL_INTENSITY16")] Intensity16 = 0x804D,
    [NativeName("Name", "GL_V2F")] V2f = 0x2A20,
    [NativeName("Name", "GL_V3F")] V3f = 0x2A21,
    [NativeName("Name", "GL_C4UB_V2F")] C4UBV2f = 0x2A22,
    [NativeName("Name", "GL_C4UB_V3F")] C4UBV3f = 0x2A23,
    [NativeName("Name", "GL_C3F_V3F")] C3fV3f = 0x2A24,
    [NativeName("Name", "GL_N3F_V3F")] N3fV3f = 0x2A25,
    [NativeName("Name", "GL_C4F_N3F_V3F")] C4fN3fV3f = 0x2A26,
    [NativeName("Name", "GL_T2F_V3F")] T2fV3f = 0x2A27,
    [NativeName("Name", "GL_T4F_V4F")] T4fV4f = 0x2A28,

    [NativeName("Name", "GL_T2F_C4UB_V3F")]
    T2fC4UBV3f = 0x2A29,
    [NativeName("Name", "GL_T2F_C3F_V3F")] T2fC3fV3f = 0x2A2A,
    [NativeName("Name", "GL_T2F_N3F_V3F")] T2fN3fV3f = 0x2A2B,
    ...
    [NativeName("Name", "GL_TEXTURE_3D")] Texture3D = 0x806F,
    ...
    [NativeName("Name", "GL_BGR")] Bgr = 0x80E0,
    [NativeName("Name", "GL_BGRA")] Bgra = 0x80E1,
    ...
    [NativeName("Name", "GL_TEXTURE0")] Texture0 = 0x84C0,
    [NativeName("Name", "GL_TEXTURE1")] Texture1 = 0x84C1,
    [NativeName("Name", "GL_TEXTURE2")] Texture2 = 0x84C2,
    [NativeName("Name", "GL_TEXTURE3")] Texture3 = 0x84C3,
    [NativeName("Name", "GL_TEXTURE4")] Texture4 = 0x84C4,
    [NativeName("Name", "GL_TEXTURE5")] Texture5 = 0x84C5,
    [NativeName("Name", "GL_TEXTURE6")] Texture6 = 0x84C6,
    [NativeName("Name", "GL_TEXTURE7")] Texture7 = 0x84C7,
    [NativeName("Name", "GL_TEXTURE8")] Texture8 = 0x84C8,
    [NativeName("Name", "GL_TEXTURE9")] Texture9 = 0x84C9,
    [NativeName("Name", "GL_TEXTURE10")] Texture10 = 0x84CA,
    [NativeName("Name", "GL_TEXTURE11")] Texture11 = 0x84CB,
    [NativeName("Name", "GL_TEXTURE12")] Texture12 = 0x84CC,
    [NativeName("Name", "GL_TEXTURE13")] Texture13 = 0x84CD,
    [NativeName("Name", "GL_TEXTURE14")] Texture14 = 0x84CE,
    [NativeName("Name", "GL_TEXTURE15")] Texture15 = 0x84CF,
    [NativeName("Name", "GL_TEXTURE16")] Texture16 = 0x84D0,
    [NativeName("Name", "GL_TEXTURE17")] Texture17 = 0x84D1,
    [NativeName("Name", "GL_TEXTURE18")] Texture18 = 0x84D2,
    [NativeName("Name", "GL_TEXTURE19")] Texture19 = 0x84D3,
    [NativeName("Name", "GL_TEXTURE20")] Texture20 = 0x84D4,
    [NativeName("Name", "GL_TEXTURE21")] Texture21 = 0x84D5,
    [NativeName("Name", "GL_TEXTURE22")] Texture22 = 0x84D6,
    [NativeName("Name", "GL_TEXTURE23")] Texture23 = 0x84D7,
    [NativeName("Name", "GL_TEXTURE24")] Texture24 = 0x84D8,
    [NativeName("Name", "GL_TEXTURE25")] Texture25 = 0x84D9,
    [NativeName("Name", "GL_TEXTURE26")] Texture26 = 0x84DA,
    [NativeName("Name", "GL_TEXTURE27")] Texture27 = 0x84DB,
    [NativeName("Name", "GL_TEXTURE28")] Texture28 = 0x84DC,
    [NativeName("Name", "GL_TEXTURE29")] Texture29 = 0x84DD,
    [NativeName("Name", "GL_TEXTURE30")] Texture30 = 0x84DE,
    [NativeName("Name", "GL_TEXTURE31")] Texture31 = 0x84DF,

    [NativeName("Name", "GL_ACTIVE_TEXTURE")]
    ActiveTexture = 0x84E0,
    [NativeName("Name", "GL_MULTISAMPLE")] Multisample = 0x809D,
    ...
    [NativeName("Name", "GL_SAMPLES")] Samples = 0x80A9,
    ...
    [NativeName("Name", "GL_NORMAL_MAP")] NormalMap = 0x8511,
    ...
    [NativeName("Name", "GL_COMBINE")] Combine = 0x8570,
    [NativeName("Name", "GL_COMBINE_RGB")] CombineRgb = 0x8571,

    [NativeName("Name", "GL_COMBINE_ALPHA")]
    CombineAlpha = 0x8572,
    [NativeName("Name", "GL_SOURCE0_RGB")] Source0Rgb = 0x8580,
    [NativeName("Name", "GL_SOURCE1_RGB")] Source1Rgb = 0x8581,
    [NativeName("Name", "GL_SOURCE2_RGB")] Source2Rgb = 0x8582,
    ...
    [NativeName("Name", "GL_RGB_SCALE")] RgbScale = 0x8573,
    [NativeName("Name", "GL_ADD_SIGNED")] AddSigned = 0x8574,
    [NativeName("Name", "GL_INTERPOLATE")] Interpolate = 0x8575,
    [NativeName("Name", "GL_SUBTRACT")] Subtract = 0x84E7,
    [NativeName("Name", "GL_CONSTANT")] Constant = 0x8576,

    [NativeName("Name", "GL_PRIMARY_COLOR")]
    PrimaryColor = 0x8577,
    [NativeName("Name", "GL_PREVIOUS")] Previous = 0x8578,
    [NativeName("Name", "GL_DOT3_RGB")] Dot3Rgb = 0x86AE,
    [NativeName("Name", "GL_DOT3_RGBA")] Dot3Rgba = 0x86AF,
    ...
    [NativeName("Name", "GL_INCR_WRAP")] IncrWrap = 0x8507,
    [NativeName("Name", "GL_DECR_WRAP")] DecrWrap = 0x8508,
    ...
    [NativeName("Name", "GL_COLOR_SUM")] ColorSum = 0x8458,
    ...
    [NativeName("Name", "GL_BLEND_COLOR")] BlendColor = 0x8005,
    ...
    [NativeName("Name", "GL_FUNC_ADD")] FuncAdd = 0x8006,
    ...
    FuncSubtract = 0x800A,
    [NativeName("Name", "GL_MIN")] Min = 0x8007,
    [NativeName("Name", "GL_MAX")] Max = 0x8008,
    [NativeName("Name", "GL_BUFFER_SIZE")] BufferSize = 0x8764,
    ...
    [NativeName("Name", "GL_READ_ONLY")] ReadOnly = 0x88B8,
    [NativeName("Name", "GL_WRITE_ONLY")] WriteOnly = 0x88B9,
    [NativeName("Name", "GL_READ_WRITE")] ReadWrite = 0x88BA,
    ...
    [NativeName("Name", "GL_STREAM_DRAW")] StreamDraw = 0x88E0,
    [NativeName("Name", "GL_STREAM_READ")] StreamRead = 0x88E1,
    [NativeName("Name", "GL_STREAM_COPY")] StreamCopy = 0x88E2,
    [NativeName("Name", "GL_STATIC_DRAW")] StaticDraw = 0x88E4,
    [NativeName("Name", "GL_STATIC_READ")] StaticRead = 0x88E5,
    [NativeName("Name", "GL_STATIC_COPY")] StaticCopy = 0x88E6,
    ...
    [NativeName("Name", "GL_SRC1_ALPHA")] Src1Alpha = 0x8589,
    ...
    FogCoordSrc = 0x8450,
    [NativeName("Name", "GL_FOG_COORD")] FogCoord = 0x8451,
    ...
    [NativeName("Name", "GL_SRC0_RGB")] Src0Rgb = 0x8580,
    [NativeName("Name", "GL_SRC1_RGB")] Src1Rgb = 0x8581,
    [NativeName("Name", "GL_SRC2_RGB")] Src2Rgb = 0x8582,
    [NativeName("Name", "GL_SRC0_ALPHA")] Src0Alpha = 0x8588,
    [NativeName("Name", "GL_SRC2_ALPHA")] Src2Alpha = 0x858A,
    ...
    [NativeName("Name", "GL_SHADER_TYPE")] ShaderType = 0x8B4F,
    [NativeName("Name", "GL_FLOAT_VEC2")] FloatVec2 = 0x8B50,
    [NativeName("Name", "GL_FLOAT_VEC3")] FloatVec3 = 0x8B51,
    [NativeName("Name", "GL_FLOAT_VEC4")] FloatVec4 = 0x8B52,
    [NativeName("Name", "GL_INT_VEC2")] IntVec2 = 0x8B53,
    [NativeName("Name", "GL_INT_VEC3")] IntVec3 = 0x8B54,
    [NativeName("Name", "GL_INT_VEC4")] IntVec4 = 0x8B55,
    [NativeName("Name", "GL_BOOL")] Bool = 0x8B56,
    [NativeName("Name", "GL_BOOL_VEC2")] BoolVec2 = 0x8B57,
    [NativeName("Name", "GL_BOOL_VEC3")] BoolVec3 = 0x8B58,
    [NativeName("Name", "GL_BOOL_VEC4")] BoolVec4 = 0x8B59,
    [NativeName("Name", "GL_FLOAT_MAT2")] FloatMat2 = 0x8B5A,
    [NativeName("Name", "GL_FLOAT_MAT3")] FloatMat3 = 0x8B5B,
    [NativeName("Name", "GL_FLOAT_MAT4")] FloatMat4 = 0x8B5C,
    [NativeName("Name", "GL_SAMPLER_1D")] Sampler1D = 0x8B5D,
    [NativeName("Name", "GL_SAMPLER_2D")] Sampler2D = 0x8B5E,
    [NativeName("Name", "GL_SAMPLER_3D")] Sampler3D = 0x8B5F,
    ...
    [NativeName("Name", "GL_LINK_STATUS")] LinkStatus = 0x8B82,
    ...
    [NativeName("Name", "GL_LOWER_LEFT")] LowerLeft = 0x8CA1,
    [NativeName("Name", "GL_UPPER_LEFT")] UpperLeft = 0x8CA2,
    ...
    FloatMat4x3 = 0x8B6A,
    [NativeName("Name", "GL_SRGB")] Srgb = 0x8C40,
    [NativeName("Name", "GL_SRGB8")] Srgb8 = 0x8C41,
    [NativeName("Name", "GL_SRGB_ALPHA")] SrgbAlpha = 0x8C42,
    ...
    [NativeName("Name", "GL_SLUMINANCE")] Sluminance = 0x8C46,
    [NativeName("Name", "GL_SLUMINANCE8")] Sluminance8 = 0x8C47,
    ...
    [NativeName("Name", "GL_RGBA32F")] Rgba32f = 0x8814,
    [NativeName("Name", "GL_RGB32F")] Rgb32f = 0x8815,
    [NativeName("Name", "GL_RGBA16F")] Rgba16f = 0x881A,
    [NativeName("Name", "GL_RGB16F")] Rgb16f = 0x881B,
    ...
    [NativeName("Name", "GL_FIXED_ONLY")] FixedOnly = 0x891D,
    ...
    [NativeName("Name", "GL_RGB9_E5")] Rgb9E5 = 0x8C3D,
    ...
    [NativeName("Name", "GL_RGBA32UI")] Rgba32ui = 0x8D70,
    [NativeName("Name", "GL_RGB32UI")] Rgb32ui = 0x8D71,
    [NativeName("Name", "GL_RGBA16UI")] Rgba16ui = 0x8D76,
    [NativeName("Name", "GL_RGB16UI")] Rgb16ui = 0x8D77,
    [NativeName("Name", "GL_RGBA8UI")] Rgba8ui = 0x8D7C,
    [NativeName("Name", "GL_RGB8UI")] Rgb8ui = 0x8D7D,
    [NativeName("Name", "GL_RGBA32I")] Rgba32i = 0x8D82,
    [NativeName("Name", "GL_RGB32I")] Rgb32i = 0x8D83,
    [NativeName("Name", "GL_RGBA16I")] Rgba16i = 0x8D88,
    [NativeName("Name", "GL_RGB16I")] Rgb16i = 0x8D89,
    [NativeName("Name", "GL_RGBA8I")] Rgba8i = 0x8D8E,
    [NativeName("Name", "GL_RGB8I")] Rgb8i = 0x8D8F,
    [NativeName("Name", "GL_RED_INTEGER")] RedInteger = 0x8D94,
    ...
    BlueInteger = 0x8D96,
    [NativeName("Name", "GL_RGB_INTEGER")] RgbInteger = 0x8D98,

    [NativeName("Name", "GL_RGBA_INTEGER")]
    RgbaInteger = 0x8D99,
    [NativeName("Name", "GL_BGR_INTEGER")] BgrInteger = 0x8D9A,
    ...
    [NativeName("Name", "GL_QUERY_WAIT")] QueryWait = 0x8E13,
    ...
    [NativeName("Name", "GL_FRAMEBUFFER")] Framebuffer = 0x8D40,
    ...
    [NativeName("Name", "GL_MAX_SAMPLES")] MaxSamples = 0x8D57,
    [NativeName("Name", "GL_INDEX")] Index = 0x8222,
    ...
    [NativeName("Name", "GL_HALF_FLOAT")] HalfFloat = 0x140B,
    ...
    [NativeName("Name", "GL_RG")] RG = 0x8227,
    [NativeName("Name", "GL_RG_INTEGER")] RGInteger = 0x8228,
    [NativeName("Name", "GL_R8")] R8 = 0x8229,
    [NativeName("Name", "GL_R16")] R16 = 0x822A,
    [NativeName("Name", "GL_RG8")] RG8 = 0x822B,
    [NativeName("Name", "GL_RG16")] RG16 = 0x822C,
    [NativeName("Name", "GL_R16F")] R16f = 0x822D,
    [NativeName("Name", "GL_R32F")] R32f = 0x822E,
    [NativeName("Name", "GL_RG16F")] RG16f = 0x822F,
    [NativeName("Name", "GL_RG32F")] RG32f = 0x8230,
    [NativeName("Name", "GL_R8I")] R8i = 0x8231,
    [NativeName("Name", "GL_R8UI")] R8ui = 0x8232,
    [NativeName("Name", "GL_R16I")] R16i = 0x8233,
    [NativeName("Name", "GL_R16UI")] R16ui = 0x8234,
    [NativeName("Name", "GL_R32I")] R32i = 0x8235,
    [NativeName("Name", "GL_R32UI")] R32ui = 0x8236,
    [NativeName("Name", "GL_RG8I")] RG8i = 0x8237,
    [NativeName("Name", "GL_RG8UI")] RG8ui = 0x8238,
    [NativeName("Name", "GL_RG16I")] RG16i = 0x8239,
    [NativeName("Name", "GL_RG16UI")] RG16ui = 0x823A,
    [NativeName("Name", "GL_RG32I")] RG32i = 0x823B,
    [NativeName("Name", "GL_RG32UI")] RG32ui = 0x823C,
    ...
    [NativeName("Name", "GL_R8_SNORM")] R8SNorm = 0x8F94,
    [NativeName("Name", "GL_RG8_SNORM")] RG8SNorm = 0x8F95,
    [NativeName("Name", "GL_RGB8_SNORM")] Rgb8SNorm = 0x8F96,
    [NativeName("Name", "GL_RGBA8_SNORM")] Rgba8SNorm = 0x8F97,
    [NativeName("Name", "GL_R16_SNORM")] R16SNorm = 0x8F98,
    [NativeName("Name", "GL_RG16_SNORM")] RG16SNorm = 0x8F99,
    [NativeName("Name", "GL_RGB16_SNORM")] Rgb16SNorm = 0x8F9A,
    ...
    [NativeName("Name", "GL_DEPTH_CLAMP")] DepthClamp = 0x864F,
    ...
    [NativeName("Name", "GL_OBJECT_TYPE")] ObjectType = 0x9112,

    [NativeName("Name", "GL_SYNC_CONDITION")]
    SyncCondition = 0x9113,
    [NativeName("Name", "GL_SYNC_STATUS")] SyncStatus = 0x9114,
    [NativeName("Name", "GL_SYNC_FLAGS")] SyncFlags = 0x9115,
    [NativeName("Name", "GL_SYNC_FENCE")] SyncFence = 0x9116,

    [NativeName("Name", "GL_SYNC_GPU_COMMANDS_COMPLETE")]
    SyncGpuCommandsComplete = 0x9117,
    [NativeName("Name", "GL_UNSIGNALED")] Unsignaled = 0x9118,
    [NativeName("Name", "GL_SIGNALED")] Signaled = 0x9119,
    ...
    [NativeName("Name", "GL_WAIT_FAILED")] WaitFailed = 0x911D,
    ...
    [NativeName("Name", "GL_SAMPLE_MASK")] SampleMask = 0x8E51,
    ...
    [NativeName("Name", "GL_SRC1_COLOR")] Src1Color = 0x88F9,
    ...
    [NativeName("Name", "GL_RGB10_A2UI")] Rgb10A2ui = 0x906F,
    ...
    TimeElapsed = 0x88BF,
    [NativeName("Name", "GL_TIMESTAMP")] Timestamp = 0x8E28,
    ...
    [NativeName("Name", "GL_DOUBLE_VEC2")] DoubleVec2 = 0x8FFC,
    [NativeName("Name", "GL_DOUBLE_VEC3")] DoubleVec3 = 0x8FFD,
    [NativeName("Name", "GL_DOUBLE_VEC4")] DoubleVec4 = 0x8FFE,
    [NativeName("Name", "GL_DOUBLE_MAT2")] DoubleMat2 = 0x8F46,
    [NativeName("Name", "GL_DOUBLE_MAT3")] DoubleMat3 = 0x8F47,
    [NativeName("Name", "GL_DOUBLE_MAT4")] DoubleMat4 = 0x8F48,
    ...
    [NativeName("Name", "GL_PATCHES")] Patches = 0xE,
    ...
    [NativeName("Name", "GL_ISOLINES")] Isolines = 0x8E7A,
    ...
    [NativeName("Name", "GL_FIXED")] Fixed = 0x140C,
    ...
    [NativeName("Name", "GL_LOW_FLOAT")] LowFloat = 0x8DF0,

    [NativeName("Name", "GL_MEDIUM_FLOAT")]
    MediumFloat = 0x8DF1,
    [NativeName("Name", "GL_HIGH_FLOAT")] HighFloat = 0x8DF2,
    [NativeName("Name", "GL_LOW_INT")] LowInt = 0x8DF3,
    [NativeName("Name", "GL_MEDIUM_INT")] MediumInt = 0x8DF4,
    [NativeName("Name", "GL_HIGH_INT")] HighInt = 0x8DF5,
    ...
    [NativeName("Name", "GL_RGB565")] Rgb565 = 0x8D62,
    ...
    [NativeName("Name", "GL_IMAGE_1D")] Image1D = 0x904C,
    [NativeName("Name", "GL_IMAGE_2D")] Image2D = 0x904D,
    [NativeName("Name", "GL_IMAGE_3D")] Image3D = 0x904E,

    [NativeName("Name", "GL_IMAGE_2D_RECT")]
    Image2DRect = 0x904F,
    [NativeName("Name", "GL_IMAGE_CUBE")] ImageCube = 0x9050,
    ...
    [NativeName("Name", "GL_BUFFER")] Buffer = 0x82E0,
    [NativeName("Name", "GL_SHADER")] Shader = 0x82E1,
    [NativeName("Name", "GL_PROGRAM")] Program = 0x82E2,
    [NativeName("Name", "GL_QUERY")] Query = 0x82E3,

    [NativeName("Name", "GL_PROGRAM_PIPELINE")]
    ProgramPipeline = 0x82E4,
    [NativeName("Name", "GL_SAMPLER")] Sampler = 0x82E6,
    ...
    [NativeName("Name", "GL_MAX_WIDTH")] MaxWidth = 0x827E,
    [NativeName("Name", "GL_MAX_HEIGHT")] MaxHeight = 0x827F,
    [NativeName("Name", "GL_MAX_DEPTH")] MaxDepth = 0x8280,
    [NativeName("Name", "GL_MAX_LAYERS")] MaxLayers = 0x8281,
    ...
    [NativeName("Name", "GL_READ_PIXELS")] ReadPixels = 0x828C,
    ...
    [NativeName("Name", "GL_MIPMAP")] Mipmap = 0x8293,
    ...
    [NativeName("Name", "GL_SRGB_READ")] SrgbRead = 0x8297,
    [NativeName("Name", "GL_SRGB_WRITE")] SrgbWrite = 0x8298,
    [NativeName("Name", "GL_FILTER")] Filter = 0x829A,
    ...
    [NativeName("Name", "GL_UNIFORM")] Uniform = 0x92E1,
    ...
    [NativeName("Name", "GL_NAME_LENGTH")] NameLength = 0x92F9,
    [NativeName("Name", "GL_TYPE")] Type = 0x92FA,
    [NativeName("Name", "GL_ARRAY_SIZE")] ArraySize = 0x92FB,
    [NativeName("Name", "GL_OFFSET")] Offset = 0x92FC,
    [NativeName("Name", "GL_BLOCK_INDEX")] BlockIndex = 0x92FD,
    ...
    [NativeName("Name", "GL_LOCATION")] Location = 0x930E,
    ...
    [NativeName("Name", "GL_ZERO_TO_ONE")] ZeroToOne = 0x935F,
    [NativeName("Name", "GL_CLIP_ORIGIN")] ClipOrigin = 0x935C,
    ...
    [NativeName("Name", "GL_COLOR_TABLE")] ColorTable = 0x80D0,
    ...
    Separable2D = 0x8012,
    [NativeName("Name", "GL_HISTOGRAM")] Histogram = 0x8024,

    [NativeName("Name", "GL_PROXY_HISTOGRAM")]
    ProxyHistogram = 0x8025,
    [NativeName("Name", "GL_MINMAX")] Minmax = 0x802E,
