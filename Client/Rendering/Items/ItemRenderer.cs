...
namespace betareborn.Client.Rendering.Items
{
    public class ItemRenderer : EntityRenderer
    {
        ...
        public void doRenderItem(EntityItem var1, double var2, double var4, double var6, float var8, float var9)
        {
            ...
            float var11 = MathHelper.sin((var1.itemAge + var9) / 10.0F + var1.bobPhase) * 0.1F + 0.1F;
            float var12 = ((var1.itemAge + var9) / 20.0F + var1.bobPhase) * (180.0F / (float)java.lang.Math.PI);
            byte var13 = 1;
